...
Private odbc_trans_encours As Boolean
...
err_open_resultset:
    MsgBox "Erreur OpenResultset " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_AddNew)"
...
err_addnew:
    MsgBox "Erreur AddNew " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_AddNew)"
    rs.Close
    Odbc_AddNew = P_ERREUR
    Exit Function
...
err_edit:
    MsgBox "Erreur Edit " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_AddNew)"
    rs.Close
    Odbc_AddNew = P_ERREUR
    Exit Function
...
err_affecte:
    MsgBox "Erreur Affectation pour " & scol & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_AddNew)"
    rs.Close
    Odbc_AddNew = P_ERREUR
    Exit Function
...
err_update:
    MsgBox "Erreur Update " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_AddNew)"
    rs.Close
    Odbc_AddNew = P_ERREUR
    Exit Function
...
err_begintrans:
    MsgBox "Erreur BeginTrans" & vbCrLf & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_BeginTrans)"
    Odbc_BeginTrans = P_ERREUR
    Exit Function
...
Public Function Odbc_Count(ByVal v_sql As String, _
                            ByRef r_count As Long) As Integer
...
err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + v_sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Count)"
    Odbc_Count = P_ERREUR
    Exit Function
...
err_execute:
    MsgBox "Erreur Create Table " & sql & vbCrLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_CreateTable)"
...
err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Delock)"
    Exit Sub

err_edit:
    MsgBox "Erreur Edit pour " + sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Delock)"
    rs.Close
    Exit Sub

err_affecte:
    MsgBox "Erreur Affectation pour " + sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Delock)"
    rs.Close
    Exit Sub

err_update:
    MsgBox "Erreur Update pour " + sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Delock)"
    rs.Close
    Exit Sub
...
Function Odbc_EstDoublon(ByVal v_nomtbl As String, _
    ...
    sql = "SELECT " & v_nomcol0 & ", " & v_nomcol _
        & " FROM " & v_nomtbl _
...
err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_EstDoublon)"
...
Public Function Odbc_Init(ByVal v_stypebdd As String, _
                          ByVal v_nombdd As String) As Integer
...
err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_lock)"
    Odbc_Lock = P_ERREUR
    Exit Function
...
err_no_val:
    MsgBox "Pas de valeur en position " & i & " pour " & v_sql & vbCr & vbLf & Err.Description, _
            vbOKOnly + vbCritical, ""
    rs.Close
    Odbc_RecupVal = P_ERREUR
    Exit Function
...
err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + v_sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Select)"
...
Public Function Odbc_SelectV(ByVal v_sql As String, _
                             ByRef r_rs As rdoResultset) As Integer
' ne retourne pas d'erreurs quand-t-il n'y a pas de lignes
...
err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + v_sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_SelectV)"
    Odbc_SelectV = P_ERREUR
    Exit Function

End Function

Public Function Odbc_SelectV_Update(ByVal v_sql As String, _
                             ByRef r_rs As rdoResultset) As Integer
' on peut editer l'enregistrement en cours
' ne retourne pas d'erreurs quand-t-il n'y a pas de lignes

    On Error GoTo err_open_resultset
    Set r_rs = Odbc_Cnx.OpenResultset(v_sql, rdOpenKeyset)
    On Error GoTo 0

    Odbc_SelectV_Update = P_OK
    Exit Function

err_open_resultset:
    MsgBox "Erreur OpenResultSet pour " + v_sql & vbLf & vbCr & "Erreur=" & Err.Number & vbLf & vbCr & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_SelectV_Update)"
    Odbc_SelectV_Update = P_ERREUR
    Exit Function
...
'Transforme les ' en ''
'Transforme les * en %
Public Function Odbc_String(ByVal a_str As String) As String

    Dim s As String

    s = STR_Remplacer(a_str, "*", "%")
    a_str = s
    s = STR_Remplacer(a_str, "'", "''")
    Odbc_String = "'" & s & "'"
...
Public Function Odbc_TableExiste(ByVal v_nomtbl As String) As Boolean
    ...
    If Odbc_type_base = ODBC_BDD_MDB Then
        Call MsgBox("Fonction : Odbc_TableExiste non implémentée")
...
err_open_resultset:
    MsgBox "Erreur OpenResultset " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Update)"
...
err_affecte:
    MsgBox "Erreur Affectation colonne " & n & " pour " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_Update)"
    rs.Close
    Odbc_Update = P_ERREUR
    Exit Function
...
err_open_resultset:
    MsgBox "Erreur OpenResultset " & sql & vbCr & vbLf & "Erreur=" & Err.Number & " " & Err.Description, _
            vbOKOnly + vbCritical, "MOdbc (Odbc_UpdateP)"
