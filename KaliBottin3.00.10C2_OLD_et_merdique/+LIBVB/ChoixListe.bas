...
Public Type CL_SPRMFRM
    ...
    b_txtRecherche As Boolean
    s_txtRecherche As String
End Type
...
Public Sub CL_InitRecherche(ByVal b_texte As Boolean, ByVal v_texte As String)
    
    CL_liste.prmfrm.b_txtRecherche = b_texte
    CL_liste.prmfrm.s_txtRecherche = v_texte
...
Public Sub CL_Init()
    ...
    CL_liste.prmfrm.b_txtRecherche = False
