...
Private Function charger_identifant() As Integer
    ...
    Label1.Caption = "KaliAlerte - V1.00.07 - " & UCase(Left$(sprenom, 1) & "." & snom)
...
Private Sub cmd_Click(Index As Integer)
    ...
    ElseIf Index = CMD_KD Then
        Shell "C:\KaliDoc\Lance.exe c:\kalidoc;kalidoc;kalidoc.ini;" & p_numUtil, vbNormalFocus
