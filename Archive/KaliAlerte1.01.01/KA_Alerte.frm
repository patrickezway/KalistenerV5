...
Private Function charger_identifant() As Integer
    ...
    Label1.Caption = "KaliAlerte - V1.01.01 - " & UCase(Left$(sprenom, 1) & "." & snom)
...
Private Sub cmd_Click(Index As Integer)
    ...
    ElseIf Index = CMD_KD Then
        Shell "C:\KaliDoc\Lance.exe c:\kalidoc;kalidoc;kalidoc.ini;CONNEXION=" & p_numUtil, vbNormalFocus
