...
Private Function charger_identifant() As Integer
    ...
    Label1.Caption = "KaliAlerte - V2.00.00 - " & UCase(Left$(sprenom, 1) & "." & snom)
...
Private Function charger_modif() As Integer
    ...
    sql = "select DACR_Titre, DACR_Descr, U_Nom, DDM_ModifVu,DDM_DateDemande " _
...
Private Sub Form_Load()
    ...
    'Gestion du timer
    If GetSetting(p_nomappli, "Section", "Rafraichissement") <> "" Then
        g_ltimer = GetSetting(p_nomappli, "Section", "Rafraichissement")
    Else
        g_ltimer = 60000
        SaveSetting p_nomappli, "Section", "Rafraichissement", 60000
    End If
   ' Timer1.Enabled = True
